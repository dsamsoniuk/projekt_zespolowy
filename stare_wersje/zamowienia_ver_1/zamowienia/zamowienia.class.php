...
class zamowienia extends main {
	...
	public function wyslij($fotograf_id, $klient_id, $tytul, $komentarz, $wyb_pakiety){
		...
		$tytul = $this->zabezpieczenie_sql($tytul);
		$komentarz = $this->zabezpieczenie_sql($komentarz);



		$this->connect_sql();

		$sql = "INSERT INTO `zamowienie`  VALUES(NULL, '".$komentarz."', CURRENT_TIMESTAMP, ".$fotograf_id.", ".$klient_id.");";
		mysql_query($sql);
